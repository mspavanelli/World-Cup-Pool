...
O trabalho é acompanhado nas GitHub Issues e no roadmap. Cada issue possui uma label `status:` e uma `type:`; milestones agrupam o trabalho por fase de entrega. Os comandos de desenvolvimento e teste serão documentados quando a fundação da aplicação estiver definida.
